...
public class ErfolgeController : MonoBehaviour
{
        ...
        kategorien = new List<ErfolgsKategorie>
        {
            new ErfolgsKategorie
            {
                ...
                erfolge = new List<Erfolg>
                {
                    ...
                    new Erfolg { id = "e_swot",          titel = "SWOT-Analyse erstellt",       beschreibung = "SWOT-Analyse im Dok-Pool hinterlegt",             icon = "⚖️", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_zielgruppenanalyse", titel = "Zielgruppe definiert",   beschreibung = "Zielgruppenanalyse im Dok-Pool hinterlegt",       icon = "🎯", typ = ErfolgTyp.Einmalig },
                    ...
                    new Erfolg { id = "e_steuerfragebogen", titel = "Steuerlich erfasst",       beschreibung = "Fragebogen zur steuerlichen Erfassung hinterlegt", icon = "🧾", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_bg_anmeldung",  titel = "Bei der Berufsgenossenschaft angemeldet", beschreibung = "Anmeldung Berufsgenossenschaft hinterlegt", icon = "🛡", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_organigramm",   titel = "Organigramm erstellt",        beschreibung = "Team- und Rollenverteilung hinterlegt",            icon = "🧩", typ = ErfolgTyp.Einmalig },
                }
            },
            new ErfolgsKategorie
            {
                ...
                erfolge = new List<Erfolg>
                {
                    ...
                    new Erfolg { id = "e_zahlungsbedingungen", titel = "Zahlungsbedingungen festgelegt", beschreibung = "Zahlungsbedingungen im Dok-Pool hinterlegt", icon = "📝", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_foerdermittel", titel = "Fördermittel geprüft",        beschreibung = "Fördermittelübersicht im Dok-Pool hinterlegt",   icon = "🏛", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_darlehensuebersicht", titel = "Darlehen im Überblick",  beschreibung = "Darlehensübersicht im Dok-Pool hinterlegt",      icon = "💳", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_versicherung",  titel = "Versicherungen dokumentiert",  beschreibung = "Versicherungsübersicht im Dok-Pool hinterlegt",  icon = "🛡", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_kundenumfrage", titel = "Kundenfeedback eingeholt",     beschreibung = "Kundenzufriedenheitsumfrage im Dok-Pool hinterlegt", icon = "😊", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_vollmacht",     titel = "Vollmacht erstellt",           beschreibung = "Vollmachtvorlage im Dok-Pool hinterlegt",         icon = "✍️", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_gutschrift",    titel = "Gutschriftvorlage bereit",     beschreibung = "Gutschriftvorlage im Dok-Pool hinterlegt",        icon = "🧾", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_inventarliste", titel = "Inventar erfasst",             beschreibung = "Inventarliste im Dok-Pool hinterlegt",            icon = "📦", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_protokoll",     titel = "Erstes Protokoll geführt",     beschreibung = "Besprechungsprotokoll im Dok-Pool hinterlegt",    icon = "🗒", typ = ErfolgTyp.Einmalig },
            ...
            new ErfolgsKategorie
            {
                ...
                erfolge = new List<Erfolg>
                {
                    ...
                    new Erfolg { id = "e_disclaimer",    titel = "Disclaimer hinterlegt",       beschreibung = "Haftungsausschluss im Dok-Pool hinterlegt",       icon = "⚠️", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_barzahlung",    titel = "Bar-Vordruck erstellt",       beschreibung = "Barzahlungsquittung im Dok-Pool hinterlegt",      icon = "💵", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_ueberweisung",  titel = "Überweisungsdaten hinterlegt",beschreibung = "Überweisungs-Informationsblatt hinterlegt",       icon = "🏦", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_sepa",          titel = "SEPA-Mandat hinterlegt",      beschreibung = "SEPA-Basislastschrift-Mandat hinterlegt",         icon = "💳", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_widerruf",      titel = "Widerrufsbelehrung erstellt", beschreibung = "Widerrufsbelehrung hinterlegt",                   icon = "↩️", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_mahnverfahren", titel = "Mahnverfahren definiert",     beschreibung = "Mahnverfahren hinterlegt",                        icon = "📮", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_ratenzahlung",  titel = "Ratenzahlung ermöglicht",     beschreibung = "Ratenzahlungsbestimmungen hinterlegt",            icon = "📆", typ = ErfolgTyp.Einmalig },
                    ...
                    new Erfolg { id = "e_copyright",     titel = "Copyright geregelt",          beschreibung = "Copyright Hinweis im Dok-Pool hinterlegt",        icon = "©️", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_lizenzhinweis", titel = "Lizenzbestimmungen definiert",beschreibung = "Lizenzhinweis Einfach im Dok-Pool hinterlegt",    icon = "📄", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_lizenzErweitert", titel = "Erweiterte Lizenz definiert", beschreibung = "Lizenzhinweis Erweitert im Dok-Pool hinterlegt", icon = "📜", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_vertraulichkeit", titel = "Vertraulichkeit geregelt",   beschreibung = "Vertraulichkeitserklärung im Dok-Pool hinterlegt", icon = "🤐", typ = ErfolgTyp.Einmalig },
            ...
            new ErfolgsKategorie
            {
                ...
                erfolge = new List<Erfolg>
                {
                    ...
                    new Erfolg { id = "e_richtlinien",   titel = "Unternehmensrichtlinien definiert", beschreibung = "Unternehmensrichtlinien im Dok-Pool hinterlegt", icon = "📘", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_socialmedia",   titel = "Social-Media-Strategie steht",beschreibung = "Social Media Strategie im Dok-Pool hinterlegt",  icon = "📱", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_team",          titel = "Team aufgebaut",              beschreibung = "Muster-Arbeitsvertrag hinterlegt",               icon = "👨‍💼", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_kuendigung",    titel = "Kündigungsvorlage erstellt",  beschreibung = "Vorlage Kündigung im Dok-Pool hinterlegt",       icon = "📋", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_stellenbeschreibung", titel = "Stelle beschrieben",    beschreibung = "Stellenbeschreibung im Dok-Pool hinterlegt",     icon = "🧑‍💻", typ = ErfolgTyp.Einmalig },
                    new Erfolg { id = "e_urlaubsantrag", titel = "Urlaubsprozess geregelt",     beschreibung = "Urlaubsantrag im Dok-Pool hinterlegt",           icon = "🏖", typ = ErfolgTyp.Einmalig },
    ...
    private void LadeDokumenteDaten()
    {
        ...
        var dokZuErfolg = new Dictionary<string, string>
        {
            ...
            { "SWOT-Analyse",                            "e_swot"          },
            { "Zielgruppenanalyse",                      "e_zielgruppenanalyse" },
            { "Gründungsurkunde",                     "e_gesellschaft"  },
            { "Gesellschaftsvertrag",                 "e_gesellschaft"  },
            { "Fragebogen zur Steuerlichen Erfassung", "e_steuerfragebogen" },
            { "Anmeldung Berufsgenossenschaft",        "e_bg_anmeldung"     },
            { "Organigramm",                           "e_organigramm"      },
            { "Gesellschafterliste",                     "e_gesellschaft"  },
            { "Kontodaten (IBAN/BIC)",                   "e_konto"         },
            { "Zahlungsbedingungen",                     "e_zahlungsbedingungen" },
            { "Fördermittelübersicht",                   "e_foerdermittel" },
            { "Darlehensübersicht",                      "e_darlehensuebersicht" },
            { "Versicherungsübersicht",                  "e_versicherung"  },
            { "Kundenzufriedenheitsumfrage",             "e_kundenumfrage" },
            { "Vollmachtvorlage",                        "e_vollmacht"     },
            { "Gutschriftvorlage",                       "e_gutschrift"    },
            { "Inventarliste",                           "e_inventarliste" },
            { "Besprechungsprotokoll",                   "e_protokoll"     },
            { "AGB",                                     "e_agb"           },
            { "Disclaimer",                              "e_disclaimer"    },
            { "Barzahlung",                              "e_barzahlung"    },
            { "Überweisung",                             "e_ueberweisung"  },
            { "SEPA-Basislastschrift-Mandat",             "e_sepa"          },
            { "Widerrufsbelehrung",                       "e_widerruf"      },
            { "Mahnverfahren",                            "e_mahnverfahren" },
            { "Ratenzahlungsbestimmungen",                "e_ratenzahlung"  },
            { "Datenschutzerklärung (DSGVO)",            "e_dsgvo"         },
            { "Impressum",                               "e_impressum"     },
            { "Copyright Hinweis",                       "e_copyright"     },
            { "Lizenzhinweis Einfach",                   "e_lizenzhinweis" },
            { "Lizenzhinweis Erweitert",                 "e_lizenzErweitert" },
            { "Vertraulichkeitserklärung",               "e_vertraulichkeit" },
            { "Corporate Identity Manual",               "e_ci"            },
            { "Unternehmensrichtlinien",                 "e_richtlinien"   },
            { "Social Media Strategie",                  "e_socialmedia"   },
            { "Muster-Arbeitsvertrag",                   "e_team"          },
            { "Vorlage Kündigung",                       "e_kuendigung"    },
            { "Stellenbeschreibung",                     "e_stellenbeschreibung" },
            { "Urlaubsantrag",                           "e_urlaubsantrag" },
